...
def get_model(token_num,
    ...
    encoder_input = keras.layers.Input(batch_shape=(batch_size,sentence_len), name='Encoder-Input')
    ...
    decoder_input = keras.layers.Input(batch_shape=(batch_size,sentence_len), name='Decoder-Input')
